...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        List<String> names = Arrays.asList("Mark", "Alan", "Junior", "Charles", "Kerry", "Francis");
        List<String> families = Arrays.asList("Ryan", "Blair", "Horn", "Byrd", "Fitzgerald", "Foster", "Copeland");
